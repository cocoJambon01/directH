...
header-text: >
  ...
  Just add <a href="https://search.maven.org/remotecontent?filepath=com/codeborne/selenide/4.10/selenide-4.10.jar">selenide.jar</a> to your project and you are done.<br/>
