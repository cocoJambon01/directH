...
header-text: >
  ...
  Just add <a href="https://search.maven.org/remotecontent?filepath=com/codeborne/selenide/4.4.3/selenide-4.4.3.jar">selenide.jar</a> to your project and you are done.<br/>
